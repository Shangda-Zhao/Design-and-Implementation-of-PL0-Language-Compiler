...
(1) I developed lexical analyzer to preprocess source strings to reduce the complexity of the parser using symbol table and convert string to the internal representation structure.

(2) I used Recursive-Descent method and Operator-Precedence method to deal with variable, function, statement, expression, and generate a syntax tree from the token stream obtained by lexical analysis.

(3) Then the analytic functions in the virtual machine could convert the syntax tree to the object code.
